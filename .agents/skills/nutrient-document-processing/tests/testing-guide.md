...
# NOTE: Use a multi-page PDF. The test PDF must have at least 3 pages to test split.py and delete-pages.py.
# Example: ~/work/pspdf/PSPDFKit-worktree/assets/science.pdf or similar
PDF=~/work/pspdf/PSPDFKit-worktree/assets/multipage.pdf
OUT=/tmp/ndp-test
mkdir -p "$OUT"
```
